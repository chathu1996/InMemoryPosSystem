...
import lk.itsei.pos.fx.util.ManageItems;
import lk.itsei.pos.fx.view.util.ItemTM;
...
public class ManageItemFormController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tblItems.getColumns().get(0).setCellValueFactory(
        ...
        tblItems.getSelectionModel().selectedItemProperty().addListener(
                new ChangeListener<ItemTM>() {
            @Override
            public void changed(ObservableValue<? extends ItemTM> observable,
                                ItemTM oldValue, ItemTM selectedItem) {
    ...
    private void btnSave_OnAction(ActionEvent event) {
        ...
        if (tblItems.getSelectionModel().isEmpty()) {
            ...
            new Alert(Alert.AlertType.INFORMATION,
                    "Item has been saved successfully",ButtonType.OK)
                    .showAndWait();
...
//            tblItems.refresh();
            ...
            ManageItems.updateItem(selectedRow,new Item(txtItemCode.getText(),
                    txtDescription.getText(),
                    Double.parseDouble(txtUnitPrice.getText()),Integer.parseInt(
                            txtQty.getText())));

            new Alert(Alert.AlertType.INFORMATION,
                    "Item has been updated successfully", ButtonType.OK)
                    .showAndWait();
        }
    ...
    private void btnDelete_OnAction(ActionEvent event) {
        ...
        if (buttonType.get() == ButtonType.YES) {
            ...
            tblItems.getItems().remove(
                    tblItems.getSelectionModel().getSelectedItem());
