...
import lk.itsei.pos.fx.view.util.OrderTM;
...
public class SearchOrderFormController {
    ...
    public void initialize(){
        ...
        ArrayList<Order> ordersDB = MangeOrders.getOrdersDB();
    ...
    private void tblOrders_OnClick(MouseEvent mouseEvent) throws IOException {
        if (mouseEvent.getClickCount() == 2){
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(this.getClass().getResource("/lk/itsei/pos/fx/view/ViewOrderForm.fxml"));
