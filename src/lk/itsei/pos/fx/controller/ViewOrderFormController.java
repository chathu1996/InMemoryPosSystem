...
public class ViewOrderFormController {
    ...
    private void navigateToMain(MouseEvent mouseEvent) throws IOException {
        ...
        Parent root = FXMLLoader.load(this.getClass().getResource("/lk/itsei/pos/fx/view/SearchOrderForm.fxml"));
    ...
    public void initialize() {
        tblOrderDetails.getColumns().get(0).setCellValueFactory(
    ...
    public void fillData() {
        Order order = MangeOrders.findOrder(this.orderId);
