...
import lk.itsei.pos.fx.util.MangeOrders;
import lk.itsei.pos.fx.view.util.OrderDetailTM;
...
public class PlaceOrderFormController {
    ...
    public void initialize() {
        ...
        txtOrderID.setText(MangeOrders.generateOrderId());
    ...
    private void btnPlaceOrderOnAction(ActionEvent actionEvent) {
        ...
        MangeOrders.createOrder(new Order(txtOrderID.getText(), txtOrderDate.getValue(),txtCustomerId.getText(),orderDetails));
    ...
    private Item validateItemCode() {
        ...
        if (item == null) {
            new Alert(Alert.AlertType.ERROR, "Invalid Item Code",
